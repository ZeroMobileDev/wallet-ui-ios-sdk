...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/ZeroMobileDev/wallet-ui-ios-sdk/archive/refs/tags/2.5.1.2.zip" }
  ...
  s.resource_bundles = {
    'WalletUISdkResources' => [
      ...
      'Frameworks/WalletUISdk.xcframework/ios-arm64/WalletUISdk.framework/*.der',
  ...
  s.dependency 'EnQualify/OCR', '2.0.6.4'
  s.dependency 'EnQualify/NFC', '2.0.6.4'
  s.dependency 'EnQualify/Face', '2.0.6.4'
  s.dependency 'AFNetworking', '4.0.1'
  s.dependency 'JSONModel', '1.7.0'
  s.dependency 'lottie-ios', '4.5.0'
  s.dependency 'FirebaseAnalytics', '10.27.0'
  s.dependency 'Masterpass'
