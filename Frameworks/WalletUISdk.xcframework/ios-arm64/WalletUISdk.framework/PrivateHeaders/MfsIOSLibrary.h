...
-(id)directPurchase:(MfsCard*)card token:(NSString*)token amount:(NSString*)amount textField:(MfsTextField*)textField cvv:(MfsTextField*)cvv orderNo:(NSString*)orderNo installmentCount:(NSNumber*)installmentCount rewardName:(NSString*)rewardName rewardValue:(NSString*)rewardValue checkbox:(MfsCheckbox*)checkbox directPurchaseCallback:(SEL)callback directPurchaseTarget:(id)target;

-(id)directPurchase:(MfsCard*)card token:(NSString*)token amount:(NSString*)amount textField:(MfsTextField*)textField cvv:(MfsTextField*)cvv orderNo:(NSString*)orderNo checkbox:(MfsCheckbox*)checkbox directPurchaseCallback:(SEL)callback directPurchaseTarget:(id)target;
