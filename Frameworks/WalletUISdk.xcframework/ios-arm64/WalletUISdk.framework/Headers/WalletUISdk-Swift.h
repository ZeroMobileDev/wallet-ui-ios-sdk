...
#ifndef WALLETUISDK_SWIFT_H
#define WALLETUISDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WalletUISdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11WalletUISdk11LoadingView")
...
SWIFT_CLASS("_TtC11WalletUISdk16PopTransitioning")
@interface PopTransitioning : NSObject <UIViewControllerAnimatedTransitioning>
...
SWIFT_CLASS("_TtC11WalletUISdk17PushTransitioning")
@interface PushTransitioning : NSObject <UIViewControllerAnimatedTransitioning>
- (NSTimeInterval)transitionDuration:(id <UIViewControllerContextTransitioning> _Nullable)transitionContext SWIFT_WARN_UNUSED_RESULT;
- (void)animateTransition:(id <UIViewControllerContextTransitioning> _Nonnull)transitionContext;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtCV11WalletUISdk15CodeScannerView21ScannerViewController")
@interface ScannerViewController : UIViewController <UINavigationControllerDelegate>
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (void)viewDidLoad;
...
SWIFT_AVAILABILITY(maccatalyst,introduced=14.0)
@interface ScannerViewController (SWIFT_EXTENSION(WalletUISdk)) <UIImagePickerControllerDelegate>
...
SWIFT_AVAILABILITY(maccatalyst,introduced=14.0)
@interface ScannerViewController (SWIFT_EXTENSION(WalletUISdk)) <AVCapturePhotoCaptureDelegate>
...
@interface UIView (SWIFT_EXTENSION(WalletUISdk))
- (void)wl_embedView:(UIView * _Nonnull)view;
- (void)wl_embedView:(UIView * _Nonnull)view insets:(UIEdgeInsets)insets;
@end
